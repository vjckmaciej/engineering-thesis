...
public class VisitControllerImpl implements VisitController {
    ...
    @Override
    @PostMapping("/add")
    public ResponseEntity<CrudResponse> addVisit(@RequestBody VisitDTO visitDTO) {
        ...
        return ResponseEntity.ok(new CrudResponse(visitId, "Visit successfully added to database!"));
    }
}
